...
def get_system_prompt(objective: str) -> str:
        ...
        system_prompt = f"""You are working together with a user to iteratively create a story. The length of the story is 15 sentences. 
...
class Story(Task):
    ...
    def generate_model_request(self, request: TaskDataRequest) -> TaskRequest:
        ...
        storytxt = f"POEM : {json.dumps(request.inputData['poem'])}"
